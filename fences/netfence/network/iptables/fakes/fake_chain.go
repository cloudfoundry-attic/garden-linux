...
type FakeChain struct {
	...
	PrependFilterRuleStub        func(protocol api.Protocol, dest string, destPort uint32) error
...
func (fake *FakeChain) PrependFilterRule(protocol api.Protocol, dest string, destPort uint32) error {
	...
	if fake.PrependFilterRuleStub != nil {
		return fake.PrependFilterRuleStub(protocol, dest, destPort)
	} else {
...
func (fake *FakeChain) PrependFilterRuleArgsForCall(i int) (api.Protocol, string, uint32) {
	fake.prependFilterRuleMutex.RLock()
	defer fake.prependFilterRuleMutex.RUnlock()
	return fake.prependFilterRuleArgsForCall[i].protocol, fake.prependFilterRuleArgsForCall[i].dest, fake.prependFilterRuleArgsForCall[i].destPort
}
